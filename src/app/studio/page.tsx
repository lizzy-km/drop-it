        ...
        <aside className={cn(
          ...
          <ScrollArea className="flex-1">
            <div className="p-2 space-y-1">
              {activeTab === 'samples' && (
                <>
                  <div className="text-[9px] font-bold text-primary/40 px-2 py-1 uppercase tracking-widest">Factory_Library</div>
                  {clips.map(clip => {
          ...
          <div className="p-4 border-t border-black bg-[#0d0f14] flex items-center gap-3">
             <img src={user.avatar} className="w-8 h-8 rounded-sm daw-button-outer" />
