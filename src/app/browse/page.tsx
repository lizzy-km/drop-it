...
export default function BrowsePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-white border-b px-6 py-6 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/studio">
             <Button className="rounded-full bg-accent hover:bg-accent/90 px-6 font-bold">
               Go to Studio
             </Button>
          </Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {creations.length === 0 ? (
            ...
            creations.map((track) => (
              <div key={track.id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl border-t-8 border-primary hover:scale-[1.02] transition-transform duration-300">
                <div className="p-8 space-y-6">
                  ...
                  <div className="bg-muted/20 rounded-3xl p-6 relative group overflow-hidden h-32 flex items-center justify-center">
                     ...
                     <div className="flex gap-2 relative z-10">
                        {/* Sample character icons from grid */}
